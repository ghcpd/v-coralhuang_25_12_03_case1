"""Unmodified baseline user display module (copied from input.py)

This file is intentionally left as the original baseline so comparisons
can be made with the refactored implementation.
"""
